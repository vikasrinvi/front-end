...
<html lang="en">
  ...
  <div class="contrainer-fluid my-4" id="3">
        ...
        <div class="carousel-inner" id="corouselImage">
            <div v-for="todo in slide">


          <div class="carousel-item" v-bind:class="todo.isActive?'active': ''">

            <img class="d-block w-100" :src="todo.img" :alt="todo.isActive">
    ...
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
            ...
            <button type="button" class="btn btn-primary" data-dismiss="modal" onclick.prevent="getFormValues()">Yes, I want to attend</button>
        </div>
        </div>
    </div>
    </div>
